!(function (o) {
  ...
  ((L.Control.BoxZoom = L.Control.extend({
    ...
    _boxZoomControlOverride_onMouseMove: function (o) {
      ...
      (this.aspectRatio && (s = l / this.aspectRatio),
        (e.style.width = l + "px"),
        (e.style.height = s + "px"));
    },
    _boxZoomControlOverride_onMouseUp: function (o) {
      ...
      if (!i.equals(n)) {
        ...
        (this._map.fitBounds(a),
          this._map.fire("boxzoomend", { boxZoomBounds: a }));
      }
    },
  })),
    ...
    (function (o) {
      ...
      if ("function" == typeof define && define.amd) define(["leaflet"], o);
        ...
        ((t = require("leaflet")), (module.exports = o(t)));
      else {
        if (void 0 === window.L)
      ...
      var t;
      ((o.Control.Zoomslider =
        ((t = o.Draggable.extend({
          initialize: function (t, e, i) {
            (o.Draggable.prototype.initialize.call(this, t, t),
              (this._element = t),
              (this._stepHeight = e),
              (this._knobHeight = i),
              this.on(
          ...
          _adjust: function (o) {
            ...
            return (
              (t = Math.max(0, Math.min(this._maxValue, t))),
              this._toY(t)
            );
          },
          _toY: function (o) {
          ...
          setSteps: function (o) {
            ...
            ((this._maxValue = o - 1),
              ...
              (this._m = t - (this._stepHeight + this._knobHeight) / 2));
          },
        ...
        o.Control.extend({
          ...
          onRemove: function (o) {
            o.off("zoomlevelschange", this._updateSize, this)
          ...
          _createUI: function () {
            ...
            return (
              (t.bar = o.DomUtil.create("div", e + " leaflet-bar")),
              (t.zoomIn = this._createZoomBtn("in", "top", t.bar)),
              (t.wrap = o.DomUtil.create(
                "div",
                e + "-wrap leaflet-bar-part",
                t.bar,
              )),
              (t.zoomOut = this._createZoomBtn("out", "bottom", t.bar)),
              (t.body = o.DomUtil.create("div", e + "-body", t.wrap)),
              (t.knob = o.DomUtil.create("div", e + "-knob")),
              o.DomEvent.disableClickPropagation(t.bar),
              o.DomEvent.disableClickPropagation(t.knob),
              t
            );
          },
          _createZoomBtn: function (t, e, i) {
            ...
            return (
              (a.href = "#"),
              (a.title = "Zoom " + t),
              o.DomEvent.on(a, "click", o.DomEvent.preventDefault),
              a
            );
          },
          _initKnob: function () {
          ...
          _initEvents: function () {
            (this._map
              ...
              o.DomEvent.on(this._ui.body, "click", this._onSliderClick, this),
              o.DomEvent.on(this._ui.zoomIn, "click", this._zoomIn, this),
              o.DomEvent.on(this._ui.zoomOut, "click", this._zoomOut, this),
          ...
          _updateSize: function () {
            ...
            ((this._ui.body.style.height = this.options.stepHeight * o + "px"),
              this._knob.setSteps(o));
          },
          ...
          _updateDisabled: function () {
            ...
            (o.DomUtil.removeClass(this._ui.zoomIn, e),
              o.DomUtil.removeClass(this._ui.zoomOut, e),
              t === this._map.getMinZoom() &&
                o.DomUtil.addClass(this._ui.zoomOut, e),
              t === this._map.getMaxZoom() &&
                o.DomUtil.addClass(this._ui.zoomIn, e));
          },
        }))),
        o.Map.addInitHook(function () {
          this.options.zoomsliderControl &&
            ((this.zoomsliderControl = new o.Control.Zoomslider()),
  ...
  class r {
    constructor(t, e) {
      ((this.surfaceInfo = e),
        (this.baseLayer = o.tileLayer.fallback(
          t.encoded_path + e.file_prefix + "{z}/tile_{x}_{y}.jpg",
          {
            tileSize: e.render_size,
            bounds: o.latLngBounds(
              this.worldToLatLng(e.world_min.x, e.world_min.y),
              this.worldToLatLng(e.world_max.x, e.world_max.y),
            ),
            noWrap: !0,
      ...
      if (s(e.stations))
        for (const t of e.stations)
          i.push(
            o
              .marker(this.midPointToLatLng(t.bounding_box), {
                title: t.backer_name,
              })
              .bindTooltip(t.backer_name, { permanent: !0 }),
          );
      ...
      if (s(e.tags))
        for (const t of e.tags)
          n.push(
            o
              .marker(this.worldToLatLng(t.position.x, t.position.y), {
                title: `${t.force_name}: ${t.text}`,
              })
              .bindTooltip(t.text, { permanent: !0 }),
          );
      this.tagsLayer = o.layerGroup(n);
      const a = [
        o.marker([0, 0], { title: "Start" }).bindPopup("Starting point"),
      ];
      if (s(e.players))
        for (const t of e.players)
          a.push(
            o
              ...
              .bindTooltip(t.name, { permanent: !0 }),
          );
      (e.player &&
        a.push(
          o
            .marker(this.worldToLatLng(e.player.x, e.player.y), {
              title: "Player",
            })
            .bindPopup("Player"),
        ),
        a.push(
          o.marker(this.worldToLatLng(e.world_min.x, e.world_min.y), {
    ...
    latLngToWorld(o) {
      ...
      return { x: o.lng * t, y: -o.lat * t };
    }
    midPointToLatLng(o) {
      return this.worldToLatLng(
        (o.left_top.x + o.right_bottom.x) / 2,
        (o.left_top.y + o.right_bottom.y) / 2,
      );
    }
  }
  function d(t) {
    (console.log("Config", t),
      fetch(t.encoded_path + "mapshot.json")
        .then((o) => o.json())
        .then((e) => {
            ...
            (function (t, e) {
              ...
              for (const o of e.surfaces) {
                ...
                (d.push(e),
                  s.addBaseLayer(
                    e.baseLayer,
                    null !== (i = o.surface_localised_name) && void 0 !== i
                      ? i
                      : o.surface_name,
                  ),
                  h.set(e.surfaceInfo.surface_idx.toString(), e),
                  h.set(e.surfaceInfo.surface_name, e));
              }
              const c = o.layerGroup(),
                m = o.layerGroup(),
                p = o.layerGroup();
              (s.addOverlay(c, "Train stations"),
                s.addOverlay(m, "Tags"),
                s.addOverlay(p, "Debug"));
              const u = new Map();
              (u.set(c, "lt"), u.set(m, "lg"), u.set(p, "ld"));
              const f = (o) => {
                  (c.clearLayers(),
                    c.addLayer(o.trainLayer),
                    m.clearLayers(),
                    m.addLayer(o.tagsLayer),
                    p.clearLayers(),
                    p.addLayer(o.debugLayer));
                },
                _ = o.map("content", {
                  crs: o.CRS.Simple,
                  layers: [],
              ...
              (s.addTo(_), o.Control.boxzoom({ position: "topleft" }).addTo(_));
              const g = new URLSearchParams(window.location.search);
              let b =
                null !==
                  (a = h.get(
                    null !== (n = g.get("s")) && void 0 !== n ? n : "1",
                  )) && void 0 !== a
                  ? a
                  : d[0];
              (_.addLayer(b.baseLayer), f(b));
              let x = l(g.get("x"), 0),
                y = l(g.get("y"), 0),
                z = l(g.get("z"), 0);
              (_.setView(b.worldToLatLng(x, y), z),
                u.forEach((o, t) => {
                  const e = g.get(o);
                  ("0" == e && _.removeLayer(t), "1" == e && _.addLayer(t));
                }),
                _.on("baselayerchange", (o) => {
                  const t = h.get(o.name);
                  if (!t) return void console.log("unknown layer", o.name);
                  ((b = t), f(b));
                  const e = new URLSearchParams(window.location.search);
                  (e.set("s", b.surfaceInfo.surface_idx.toString()),
                    history.replaceState(null, "", "?" + e.toString()));
                }));
              const v = (o) => {
                const t = _.getZoom(),
                  { x: e, y: i } = b.latLngToWorld(_.getCenter()),
              ...
              (_.on("zoomend", v), _.on("moveend", v), _.on("resize", v));
              const w = (o) => {
                const t = u.get(o.layer);
                if (!t) return void console.log("unknown layer", o.name);
                const e = new URLSearchParams(window.location.search);
                (e.set(t, "overlayadd" == o.type ? "1" : "0"),
                  history.replaceState(null, "", "?" + e.toString()));
              };
              (_.on("overlayadd", w), _.on("overlayremove", w));
            })(t, e));
        }));
  }
  const h = new URLSearchParams(window.location.search);
  if (h.get("l"))
    fetch("/latest/" + h.get("l"))
      .then((o) => o.json())
      .then((o) => {
        d(o);
      });
    ...
    const o = JSON.parse(
      JSON.stringify(
        null !== MAPSHOT_CONFIG && void 0 !== MAPSHOT_CONFIG
          ? MAPSHOT_CONFIG
          : {},
      ),
    );
    ((o.encoded_path =
      null !==
        (i =
          null !== (e = h.get("path")) && void 0 !== e ? e : o.encoded_path) &&
      void 0 !== i
        ? i
        : ""),
      o.encoded_path &&
        "/" != o.encoded_path[o.encoded_path.length - 1] &&
        (o.encoded_path = o.encoded_path + "/"),
      d(o));
  }
})(L);
//# sourceMappingURL=viewer-bf37fef2.js.map
